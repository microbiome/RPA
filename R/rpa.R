...
#sets = NULL;epsilon = 1e-2; tau2.method = "robust";d.method = "fast";verbose = FALSE;bg.method = "rma"; normalization.method = "quantiles.robust";cdf = NULL;cel.files = NULL;cel.path = NULL; probe.parameters = list(); mc.cores = 1; summarize.with.affinities = FALSE
