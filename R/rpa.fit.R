...
rpa.fit <- function (dat, cind = 1, epsilon = 1e-2, alpha = NULL, beta = NULL, sigma2.method = "robust", d.method = "fast", affinity.method = "rpa") {
  ...
  new("rpa.fit",
      list(mu = mu.orig, mu.real = mu$real, sigma2 = res$sigma2, affinity = mu$probe, data = dat))
