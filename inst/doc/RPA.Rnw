...
RPA provides a wrapper ('rpa') for gene expression preprocessing
purposes. Alternative CDF environments are supported (see help(rpa)
for details).
...
dat <- plot.rpa(rpa.results, set = "1000_at")
@
