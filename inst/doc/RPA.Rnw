...
different tests (14 tests), RPA was ranked as 1/65 and 3/95 with hgu95
and hgu133 spike-in data sets, respectively (March 13, 2011). These
results confirm the favourable preprocessing performance of RPA
(Robust Probabilistic Averaging) on short oligonucleotide array
studies. Note that in addition to preprocessing, RPA provides tools
for investigating probe performance.
