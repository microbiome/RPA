...
\begin{document} \title{Robust Probabilistic Averaging (RPA)}
...
provides tools for fully scalable preprocessing of arbitrarily large
short oligonucleotide microarray atlases. It outperforms the standard
RMA algorithm \cite{Irizarry03rma} on moderately sized data sets
\cite{Lahti11, Lahti12} and in contrast to the another scalable
alternative, fRMA \cite{McCall2011}, Online-RPA is applicable to all
short oligonucleotide platforms. In addition, RPA can be used for
probe reliability analysis, and more generally to summarize normally
distributed multivariate observations that target the same object with
varying degrees of reliability.


\section{Usage examples}

For usage examples on-line, see https://github.com/antagomir/RPA/wiki

\section{Methodology and Citations}

For details, see \cite{Lahti11, Lahti12}. Kindly cite these documents if you find the method useful.
...
\bibitem{Lahti12}
L.~Lahti, A. Torrente, L.~L. Elo, A. Brazma, J. Rung.
\newblock A fully scalable online-preprocessing algorithm for short oligonucleotide microarray atlases
\newblock In review. arXiv preprint available at: http://arxiv.org/abs/1212.5932

\bibitem{McCall2011}
MN McCall and RA Irizarry.
\newblock Thawing Frozen Robust Multi-array Analysis (fRMA)
\newblock {\em BMC Bioinformatics} 12:369, 2011.
